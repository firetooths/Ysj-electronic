...
import { DashboardIcon, ListIcon, AddIcon, CnsFaultIcon, BulkImportIcon } from '../ui/Icons';
...
export const CNSSidebar: React.FC = () => {
  return (
    <aside className="w-64 bg-white p-4 h-full shadow-md overflow-y-auto custom-scrollbar sticky top-[72px] hidden md:block">
      <nav className="space-y-2">
        ...
        <NavItem to="/cns/equipment/bulk-import" icon={<BulkImportIcon className="ml-3 text-indigo-500 fa-lg" />} label="ورود گروهی تجهیزات" />
      </nav>
    </aside>
  );
};
